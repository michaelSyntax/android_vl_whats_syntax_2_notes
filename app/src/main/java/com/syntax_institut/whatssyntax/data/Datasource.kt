...
class Datasource {
    ...
    private val contactList = listOf(
        Contact("Anna Smith", "123-456-7890", R.drawable.pp_01, Status("Mein Schwein pfeift!")),
        ...
        Contact("Mike Davis", "246-135-7920", R.drawable.pp_06, Status("Mein Schwein pfeift!")),
        ...
        Contact("Sophia Adams", "333-444-5555", R.drawable.pp_03, Status("Mein Schwein pfeift!")),
        ...
        Contact("Tim Scott", "555-444-3333", R.drawable.pp_07, Status("Mein Schwein pfeift!")),
